            ...
            <div class="col-lg-4 col-md-8">
                <div class="teachers-left mt-50">
                    <div class="hero"
                        ...
                        <img src="{{ asset($student->image_path) }}" alt="Teachers">
                    </div>
                    <div class="name">
                        <h6>{{$student->Firstname}} {{$student->Lastname}}</h6>
                        <span>Collegue : {{$student->collegue->name}}</span>
                    </div>
                    <div class="social">
                        <ul>
                            <li><a href="{{$student->github}}"><i class="fa fa-github-square"></i></a></li>
                            <li><a href="{{$student->linkedin}}"><i class="fa fa-linkedin-square"></i></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="courses" role="tabpanel" aria-labelledby="courses-tab">
                            <div class="courses-cont pt-20">
                                @if ($student->projects_info->count() > 0 )
                                <div class="row">
                                    @foreach ($student->projects_info as $key=>$project)
                                    @if ($key==2)
                                    <?php break; ?>
                                    @endif
                                    <div class="col-md-6" style="display: flex; justify-content: center; flex-direction: row; align-items: stretch; align-content: center;">
                                        <div class="singel-course mt-30">
                                            <div class="thum">
                                                <div class="image">
                                                    <img style="height: 250px !important;width:400px !important; display: flex; align-items: stretch" src="{{ $project->cover_path}}"
                                                        alt="Course">
                                                </div>
                                ...
                                left: 60px;">
                                    ...
                                    color: white;">{{$student->collegue->name}}</span>
                                </div>
                                <div class="price">
                                    <span style="width: 100%;
                                    border-radius: 15px;
                                    padding: 0 10px;
                                    color: white;">{{$project->projectForm->category->type}}</span>
                                </div>
                                            </div>
                                            <div class="cont border">
                                                ...
                                                <span>({{$project->ratings->count()}} Reviws)</span>
                                                <a href="{{ route('project', ['id'=>$project->id]) }}">
                                                    <h4>{{$project->projectForm->title}}</h4>
                                                </a>
                                                <div class="course-teacher">
                                                    <div class="thum">
                                                        <a href="#"><img
                                                                src="{{ asset($project->projectForm->professorSuper->image_path) }}"
                                                                alt="teacher"></a>
                                                    </div>
                                                    <div class="name">
                                                        <a
                                                            href="{{ route('teacher', ['id'=>$project->projectForm->professorSuper->id]) }}">
                                                            <h6>{{$project->projectForm->professorSuper->Firstname}}
                                                                {{$project->projectForm->professorSuper->Lastname}}</h6>
                                                        </a>
                                                    </div>
                                                    <div class="admin">
                                                        <ul>
                                                            <li><a href="#"><i class="fa fa-comment"></i><span>{{$project->comments->count()}}</span></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
