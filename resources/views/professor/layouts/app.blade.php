...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        {{-- Header --}}
        @include('professor.layouts._header')
        ...
        {{-- Sidebar --}}
        @include('professor.layouts._aside')
        ...
        <div class="page-wrapper">
            ...
            <!-- footer -->
            <!-- ============================================================== -->
        @include('professor.layouts._footer')
    ...
    </script>   <!-- Include the Quill library -->
    <script src="https://cdn.quilljs.com/1.3.6/quill.js"></script>
<script>
    var quill2 = new Quill('#editor3', {
placeholder: 'Compose an epic...',
theme: 'snow'
});
    // FormProject
var form2 = document.getElementById("FormProject2"); // get form by ID
