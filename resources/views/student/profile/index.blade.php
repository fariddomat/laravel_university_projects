...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body profile-card">
                    <center class="mt-4"> <img src="{{ asset($student->image_path) }}" class="rounded-circle" width="150" />
                        <h4 class="card-title mt-2"><i class="fa fa-user"></i> {{$student->Firstname}}</h4>
                        <h6 class="card-title"><span class="font-normal"> <i class="fas fa-graduation-cap"></i> Collegue : {{$student->collegue->name}}</span></h6>
                        <div class="row justify-content-center">
                            <div class="col-6">
                                <a href="javascript:void(0)" class="link">
                                    <i class="fa fa-book" aria-hidden="true"></i>
                                    <span class="font-normal"> Projects :{{$student->projects->count()}}</span>
                                </a></div>
                        </div>
                    </center>
                </div>
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal form-material mx-2" id="register_form" method="post"
                        action="{{ route('student.profile.update', ['id'=>$student->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="email" placeholder="student@uok.com"
                                    class="form-control ps-0 form-control-line" name="email" id="example-email"  value="{{$student->email}}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12 d-flex">
                                <button class="btn btn-primary mx-auto mx-md-0 text-white">Update
                                    Profile</button>
                            </div>
                        </div>
                    </form>
